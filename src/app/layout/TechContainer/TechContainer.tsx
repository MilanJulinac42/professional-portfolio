        ...
        <div className={styles.techContainer}>
            ...
            <div className={styles.techWrapper}>
                <TechCard
                    ...
                    tech="React"
                    icon={faReact}
                    description="Oživite svoje ideje sa Reactom, vodećim JavaScript okvirom za izgradnju dinamičnih i interaktivnih korisničkih interfejsa. Reactova arhitektura zasnovana na komponentama čini ga efikasnim i skalabilnim, savršenim za kreiranje privlačnih web iskustava koja osvajaju vašu publiku."
                />
                <TechCard
                    background="#d9c43b"
                    tech="JavaScript"
                ...
                <TechCard
                    ...
                    tech="Node.JS"
                    icon={faNodeJs}
                    description="Node.js je pokretačka snaga iza vaših aplikacija. Ovo serversko JavaScript run-time okruženje se ističe u rukovanju podacima u realnom vremenu, izgradnji API-ja i pokretanju visokoperformansnih web aplikacija. Node.js osigurava skalabilnost i efikasnost, omogućavajući vam da se fokusirate na kreiranje izuzetnih korisničkih iskustava."
                />
                <TechCard
                    background="#F79400"
                ...
                <TechCard
                    ...
                    tech="Drupal"
                    icon={faDrupal}
                    description="Omogućite svojim klijentima da lako upravljaju svojim sadržajem. Drupal, vodeći open-source CMS, pruža platformu jednostavnu za korišćenje za izgradnju i održavanje web sajtova i web aplikacija. Sa opsežnim opcijama za prilagođavanje i živahnom zajednicom, Drupal vam daje moć da kreirate moćna i skalabilna iskustva sadržaja."
                />
            </div>
        </div>
    );
